                  ...
                  <div class="table-responsive table-invoice">
                    ...
                    <tbody >
                      ...
                      <tr>
                        <td><?=$value->name?></td>
                        <td>
                          <a  href="<?=base_url().'admin/profession/edit/'.$this->utility->safe_b64encode($value->id)?>" class="btn btn-danger btn-action"  data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"  style="color: white"></i></a> 
