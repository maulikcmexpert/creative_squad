...
<div class="col-12 col-sm-12 col-lg-12 text-right mb-3">
	<a class="btn btn-primary" href="<?=base_url().'admin/tech/add'?>">Add</a>
</div>
</div>
    <div class="row">
              ...
              <form class="form-inline">
                ...
                <div class="card-body">
                  <div class="table-responsive table-invoice">
                    ...
                    <tbody >
                      <?php
                        foreach ($getTech as $value) { ?>
                      <tr>
                        <td><?=$value->profession_name?></td>
                        <td><?=$value->stack_name?></td>
                        <td><?=$value->tech_name?></td>
                        <td>
                          <a  href="<?=base_url().'admin/tech/edit/'.$this->utility->safe_b64encode($value->id)?>" class="btn btn-danger btn-action"  data-toggle="tooltip" title="" data-original-title="Edit"><i class="fas fa-pencil-alt"  style="color: white"></i></a> 
